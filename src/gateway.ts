...
/**
 * Relays the source bytes through the gateway (Range-aware) instead of 302-ing
 * the client. The gateway is in-cluster, so it can reach a source the client
 * cannot. Aborts the upstream fetch if the client disconnects.
 */
